...
public class Patient {
	...
	public Patient(int patientId, String patientName, String mobileNumber, String email, String bloodGroup,
			String gender, int age, String address, String userName, String password) {
		super();
		this.patientId = patientId;
		this.patientName = patientName;
		this.mobileNumber = mobileNumber;
