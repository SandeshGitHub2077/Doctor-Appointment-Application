package com.cg.doctorconsumer.exceptions;
...
import com.cg.doctorconsumer.controllers.ErrorInfo;

//@RestControllerAdvice
public class GlobalExceptionHandler {
	@ExceptionHandler(HttpClientErrorException.class)
	public ResponseEntity<ErrorInfo> httpClientErrorExceptionHandler(HttpClientErrorException exception, HttpServletRequest httpServletRequest){
		...
		ErrorInfo info = new ErrorInfo(Integer.valueOf(errors.get("httpCode")), errors.get("httpStatus"), errors.get("error"), httpServletRequest.getRequestURI());
