...
public class User implements Serializable{
	/**
	 * Serial version Uid for User class
	 */
	private static final long serialVersionUID = -8915214665750023319L;
	/**
	...
	/**
	 * is Active is used to check if the user account is active or not.
	 */
	private boolean isActive;
	/**
	 * Default constructor of the User class to initialize the Fields with default values.
	 */
	public User() {
		super();
	}
