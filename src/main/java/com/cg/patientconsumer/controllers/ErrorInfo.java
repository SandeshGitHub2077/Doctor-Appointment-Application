...
public class ErrorInfo {
	/**
	 * HTTP status code of the error info object
	 */
	private int httpCode;
	/**
	 * HTTP status name of the error info object
	 */
	private String httpStatus;
	/**
	 * Error Message of the error info object
	 */
	...
	/**
	 * 
	 * @param httpCode   HTTP status code of the error info object
	 * @param httpStatus HTTP status name of the error info object
	 * @param error      Error Message of the error info object
	 ...
	 * 
	 * @return HTTP status code of the error info object
	 */
	 ...
	 * 
	 * @return HTTP status name of the error info object
	 */
	 ...
	 * 
	 * @return Error Message of the error info object
	 */
